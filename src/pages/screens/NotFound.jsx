  ...
  return (
    <div>
      ...
      <section className='bg-dark not-found-page d-flex flex-direction-column justify-content-center align-items-center text-center p-4 border-bottom text-white'>
        ...
        <p className='fs-lead'>Parece que la página que buscas no está disponible</p>
        <Button as='link' to='/' icon="house" variant='dark' size='lg' label="Volver al inicio" className='mt-3'/>
      </section>
      <Footer />
    </div>
  )
