                  ...
                  <div className="d-flex flex-direction-column align-items-center justify-content-center">
                        ...
                        return (
                          <div key={cat} className="rounded border p-3 w-100 max-wx-md-300">
                            ...
                            <ul className="list-unstyled d-flex flex-direction-column m-0">
                              {services.map((s) => (
                                <li key={s.id + s.subCategoryId} className="bg-light-50 rounded-all-sm px-3 py-3 bg-white m-0 d-flex justify-content-space-between">
                                  ...
                                  <span><USD amount={s.servicePrice} className="fw-bold" /></span>
                                </li>
                              ))}
                            </ul>
                          </div>
                    ...
                    <div className="max-wx-lg-700 p-3 mt-5 text-center d-flex flex-direction-column gap-1">
                      <div className="d-flex gap-1 align-items-center">
                        ...
                        <span className="fs-h4 text-dark fw-bold">~<USD size="large" amount={totalPrice} /></span>
                      </div>
