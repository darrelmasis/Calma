                  ...
                  >
                    <div className='profile-card rounded-all-lg bg-neutral-0 '>
                      ...
                      <div className='profile-card-content rounded-all-lg p-3'>
                        <h2 className='mb-1 text-primary-400 fw-light fs-h5 fw-semibold mt-0'>
                          {expert.name}
                        </h2>
                        ...
                        <StringToList
                          text={expert.role}
                          className='text-center p-0 list-style-none d-flex flex-direction-column gap-1'
                          liClassName='m-0 fs-small text-muted '
                        />
                      </div>
                    </div>
                  </div>
