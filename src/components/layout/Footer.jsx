      ...
      <footer className='footer py-3'>
        <div className='container'>
          ...
          <div className='d-flex flex-direction-column flex-direction-lg-row align-items-start mb-3 px-3 mt-3 justify-content-space-between'>
            <Fade>
              <div>
                <h3 className='text-dark fs-lead text-muted mb-5'>
                ...
                <ul className='fs-medium list-unstyled list-bordered text-muted d-flex flex-direction-column gap-1 align-items-flex-start'>
                  ...
                  <li className='w-100 '>
                    ...
                    <Tooltip
                      content={t('footer.columns.contact.addressTooltip')}
                    >
                      <a
                        target='_blank'
                        href='https://maps.app.goo.gl/j9ZjqwatmQGa8aA4A'
                        className=''
                      >
            ...
            <Fade>
              <div>
                ...
                <ul className='list-unstyled fs-medium list-bordered text-muted d-flex flex-direction-column gap-1 align-items-flex-start'>
                  <li className='w-100'>
                    <Tooltip
                      content={t('footer.columns.social.facebookTooltip')}
                    >
                      <a
                        href={calmaFacebook}
                        target='_blank'
                  ...
                  <li className='w-100'>
                    <Tooltip
                      content={t('footer.columns.social.instagramTooltip')}
                    >
                      <a
                        href={calmaInstagram}
                        target='_blank'
          ...
          <div className='border-top py-5 d-flex flex-direction-column flex-direction-lg-row text-center text-lg-start gap-lg-2 align-items-center'>
            <Fade>
              <LogoCalma
                alt='Logo de Calma'
                className='wx-80 my-3 calma-logo-footer'
              />
            </Fade>
            <Fade>
              <div className='mb-lg-2'>
                <p className='fs-medium fw-semibold mb-0'>
                  {t('footer.legal.copyright')}
                </p>
                <p className='fs-medium text-muted mb-0 mt-1'>
                  {t('footer.legal.subtitle')}
                </p>
              </div>
            </Fade>
          </div>
