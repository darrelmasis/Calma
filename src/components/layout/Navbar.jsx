...
export const Navbar = () => {
  ...
  const { deviceType: type } = useDevice()
                  ...
                  <Dropdown>
                    <DropdownTrigger>
                      <div className='navbar-dropdown-info'>
                        <Button
                          variant='basic'
                          className='position-relative rounded-pill-md'
                          icon={[
                            {
                              name: 'bag-shopping',
                              variant: 'regular',
      ...
      {!isDesktop && (
        <div className='navbar-mobile d-flex d-xl-none justify-content-center'>
          <div className='container d-flex'>
            ...
            <div className='navbar-mobile-ghost'></div>{' '}
            {/* Se utiliza para completar el área del lado izquierdo del menú, para que el logo quede en el centro */}
            {/* Controles móviles */}
            ...
            <CSSTransition
              in={isMenuOpen}
              timeout={300}
              classNames='navbar-mobile-overlay'
              unmountOnExit
              nodeRef={overlayRef}
            >
              <div
            ...
            <CSSTransition
              in={isMenuOpen}
              timeout={300}
              classNames='navbar-mobile-content'
              unmountOnExit
              nodeRef={contentRef}
            >
              <div ref={contentRef} className='navbar-mobile-content'>
                <div className='container px-5'>
                  ...
                  <div className='navbar-mobile-content-cta'></div>
                </div>
              </div>
            </CSSTransition>
          </div>
