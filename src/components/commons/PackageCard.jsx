    ...
    <div className='package-card'>
      <div className='rounded w-100'>
        <div className='package-card-header p-3 rounded-top-sm position-relative'>
          ...
          <h2 className='text-white fs-lead'>
            <span className='fs-h5 fw-light me-2'>
              {t('packages.section_1.from_price_text')} /
            </span>
            {currencySymbol}
            {precio}
          </h2>
          <h2 className='text-white fs-h4'>{nombre}</h2>
          <span className='text-neutral-50 fw-light package-description fs-medium'>
            {descripcion}
          </span>
          {isFeatured && (
        ...
        <div className='px-3 pb-3'>
          <h3 className='text-muted fw-light fs-h5'>
            {t('packages.section_1.include_text')}
          </h3>
