...
export const LanguageSwitcher = ({ className = '' }) => {
  ...
  // El cambio de idioma y URL ahora se sincroniza automáticamente por el contexto
  const handleChangeLanguage = (newLang) => {
    ...
    // El toast se muestra después del cambio, ya que la URL y el contexto se sincronizan automáticamente
    setTimeout(() => {
      toast.info(
        newLang === 'es'
